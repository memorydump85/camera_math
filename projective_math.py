...
_Correspondence = namedtuple('_Correspondence', [
    'source',
    'target'
])
...
#--------------------------------------
    """ Models a set of correspondences using a locally weighted homography.
    The homography estimate is obtained using the Direct Linear Transform (DLT)
    procedure. Hence, the resulting homography does not conform to the
    structure of a planar perspective homography """

    def __init__(self, wfunc=UnitWeightingFunction(), lambda_=0):
        self._corrs = []
        self.regularization_lambda = lambda_
